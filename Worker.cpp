...
int main(int argc, char* argv[])
{
    ...
    // Подключаемся к существующим каналам, созданным сервером
    ...
    while (true)
    {
        ...
        // Выполнение упрощенного Дискретного Преобразования Фурье (ДПФ)
        Result res;
        res.size = task.size;
        ...
        // Отправка результата обратно в Browser
